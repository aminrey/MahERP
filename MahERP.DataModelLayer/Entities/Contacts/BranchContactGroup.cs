...
{
    /// <summary>
    /// گروه‌بندی افراد در سطح شعبه
    /// هر شعبه می‌تواند گروه‌های مخصوص به خود داشته باشد
    /// </summary>
    [Table("BranchContactGroup_Tbl")]
    [Index(nameof(BranchId), nameof(Code), IsUnique = true, Name = "IX_BranchContactGroup_Branch_Code")]
    public class BranchContactGroup
    {
        [Key]
        ...
        /// </summary>
        public virtual ICollection<BranchContactGroupMember> Members { get; set; } = new HashSet<BranchContactGroupMember>();
        ...
        [NotMapped]
        public string DisplayIconClass => IconClass ?? "fa-users";
    }
}
...
namespace MahERP.DataModelLayer.Migrations
{
    ...
    [Migration("20251108155048_notifytemp")]
    partial class notifytemp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MahERP.DataModelLayer.Entities.Notifications.NotificationTemplate", b =>
                {
                    ...
                    b.HasIndex("TemplateType", "TemplateCode")
                        .IsUnique()
                        .HasDatabaseName("IX_NotificationTemplate_Type_Code");
            ...
            modelBuilder.Entity("MahERP.DataModelLayer.Entities.Notifications.NotificationTemplateVariable", b =>
                {
                    ...
                    b.HasIndex("TemplateId", "VariableName")
                        .IsUnique()
                        .HasDatabaseName("IX_TemplateVariable_Template_Variable");
            ...
            modelBuilder.Entity("MahERP.DataModelLayer.Entities.Notifications.NotificationTypeTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("NotificationTypeConfigId", "ChannelType", "Priority")
                        .HasDatabaseName("IX_NotificationTypeTemplate_Type_Channel_Priority");

                    b.HasIndex("NotificationTypeConfigId", "NotificationTemplateId", "ChannelType", "UserGroupId")
                        .IsUnique()
                        .HasDatabaseName("IX_NotificationTypeTemplate_Unique")
                        .HasFilter("[UserGroupId] IS NOT NULL");

                    b.ToTable("NotificationTypeTemplate_Tbl");
                });
            ...
            modelBuilder.Entity("MahERP.DataModelLayer.Entities.Notifications.NotificationTemplate", b =>
                {
                    ...
                    b.HasOne("MahERP.DataModelLayer.Entities.AcControl.AppUsers", "LastModifier")
                        .WithMany()
            ...
            modelBuilder.Entity("MahERP.DataModelLayer.Entities.Notifications.NotificationTypeTemplate", b =>
                {
                    ...
                    b.HasOne("MahERP.DataModelLayer.Entities.Notifications.NotificationTemplate", "NotificationTemplate")
                        .WithMany("UsedInTypes")
                        .HasForeignKey("NotificationTemplateId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MahERP.DataModelLayer.Entities.Notifications.NotificationTypeConfig", "NotificationTypeConfig")
                        .WithMany("TypeTemplates")
                        .HasForeignKey("NotificationTypeConfigId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
